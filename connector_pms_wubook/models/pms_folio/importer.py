...
class ChannelWubookPmsFolioImporter(Component):
    ...
    def _after_import(self, binding):
        ...
        if binding.payment_gateway_fee > 0:
            ...
            # Wubook Pre payment
            if folio.channel_type_id == binding.backend_record.backend_type_id.direct_channel_type_id:
                journal = binding.backend_record.wubook_journal_id
            # OTAs Pre payment
            else:
                journal = binding.backend_record.backend_journal_ota_ids.filtered(
