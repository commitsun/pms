...
class PmsFolioService(Component):
    ...
    def create_folio(self, pms_folio_info):
        ...
        try:
            ...
            for reservation in folio.reservation_ids:
                service_discount_cmds = self.get_autoinclude_coupon_by_code(
    ...
    def get_autoinclude_coupon_by_code(self, reservation, internal_comment=False):
        """
        ...
        for promo in promos.filtered(
            lambda p: p.promo_code and p.promo_code in internal_comment
        ):
