...
class PmsCalendarService(Component):
    ...
    def get_calendar(self, calendar_search_param):
        ...
        selected_fields_mapper = {
            ...
            "folio_id": "folio.id as folio_id",
            "reservation_id": "reservation.id as reservation_id",
            "reservation_name": "reservation.name as reservation_name",
            "reservation_type": "reservation.reservation_type as reservation_type",
            "checkin": "reservation.checkin as checkin",
            "checkout": "reservation.checkout as checkout",
            "price_total": "reservation.price_total as price_total",
            "folio_pending_amount": "folio.pending_amount as folio_pending_amount",
            "adults": "reservation.adults as adults",
            "price_day_total": "night.price_day_total as price_day_total",
            "closure_reason_id": "folio.closure_reason_id as closure_reason_id",
